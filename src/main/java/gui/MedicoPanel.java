...
public class MedicoPanel {
    ...
    // Il costruttore non riceve stringhe o ID di dati, rispettando la separazione dei livelli
    public MedicoPanel(Controller controller, JFrame frame, JFrame frameChiamante) {
        ...
        btnLogout.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                frame.setVisible(false);
                frame.dispose(); // Dealloca la finestra corrente dalla memoria RAM
            }
        });
    }

    // Fornisce il pannello radice per l'inserimento nel content pane del frame di login
